		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
		      <ul class="nav navbar-nav">
		        <li class="active"><a href="update.board">글쓰기<span class="sr-only">(current)</span></a></li>
		  ...
		  <fieldset>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-lg-10">
		        ...
		        <input type="text" class="form-control" id="subject" value="<%= bd.getNum()%>"placeholder="이름을 입력하세요.">
