...
<html>
	...
	<body>
		...
		<!-- 게시판 글쓰기  시작  -->
		<form class="form-horizontal" method="post" action="write.board" enctype="multipart/form-data">
		  <fieldset>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-lg-10">
		        <input type="text" class="form-control" id="subject" name="sub" placeholder="제목을 입력하세요.">
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-lg-10">
		        <textarea class="form-control" rows="10" id="textArea" name="con"></textarea>
		      </div>
		    </div>
