...
<html>
	...
	<body>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
		      <ul class="nav navbar-nav">
		        <li class="active"><a href="view.board">글쓰기<span class="sr-only">(current)</span></a></li>
		...
		<%
		  Board bd =(Board) request.getAttribute("bd");
		  ...
		  <fieldset>
		    ...
		    <div class="form-group">
		     ...
		     <div class="form-group">
		      ...
		      <div class="col-lg-10">
		      	<a href="./upload/${bd.attachment}">${bd.attachment}</a> 
		      </div>
		    </div>
